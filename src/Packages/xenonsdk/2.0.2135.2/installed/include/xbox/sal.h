...
#define __inout_z_opt                                           __inout_opt __pre nullterminated __post __nullterminated
#define __inout_ecount_z_opt(size)                              __inout_ecount_opt(size) __pre nullterminated __post __nullterminated
#define __inout_ecount_z_opt(size)                              __inout_ecount_opt(size) __pre nullterminated __post __nullterminated
...
#define __deref_out_ecount_z_opt                                __deref_out_ecount_opt(size) __post __deref __nullterminated
#define __deref_out_bcount_z_opt                                __deref_out_bcount_opt(size) __post __deref __nullterminated
#define __deref_out_nz_opt                                      __deref_out_opt
#define __deref_out_ecount_nz_opt                               __deref_out_ecount_opt(size)
#define __deref_out_bcount_nz_opt                               __deref_out_bcount_opt(size)
...
#define __deref_inout_z_opt                                     __deref_inout_opt __post __deref __nullterminated
#define __deref_inout_ecount_z_opt                              __deref_inout_ecount_opt(size) __pre __deref __nullterminated __post __deref __nullterminated
#define __deref_inout_bcount_z_opt                              __deref_inout_bcount_opt(size) __pre __deref __nullterminated __post __deref __nullterminated
#define __deref_inout_nz_opt                                    __deref_inout_opt 
#define __deref_inout_ecount_nz_opt                             __deref_inout_ecount_opt(size)
#define __deref_inout_bcount_nz_opt                             __deref_inout_bcount_opt(size)
