...
_CRT_INSECURE_DEPRECATE static __inline char * __CRTDECL ctime(const time_t * _Time)
{
#pragma warning( push )
...
_CRT_INSECURE_DEPRECATE static __inline struct tm * __CRTDECL gmtime(const time_t * _Time)
{
#pragma warning( push )
#pragma warning( disable : 4996 )
...
_CRT_INSECURE_DEPRECATE static __inline struct tm * __CRTDECL localtime(const time_t * _Time)
{
#pragma warning( push )
#pragma warning( disable : 4996 )
