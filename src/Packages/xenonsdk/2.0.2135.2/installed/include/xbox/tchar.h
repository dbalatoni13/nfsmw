...
#if defined(_XBOX) && !defined(_XBOX_CRT_DEPRECATE_FAR_MAPPINGS) && !defined(_CRT_FAR_MAPPINGS_NO_DEPRECATE)
...
#define _stprintf_l     _swprintf_l
...
#define _vsntprintf_p   _vsnwprintf_p
#define _vsntprintf_p_l _vsnwprintf_p_l
...
#define _tcsclen_l      wcslen_l
#define _tcscnlen_l     wcsnlen_l
...
#else   /* __STDC__ */
__inline __checkReturn size_t __CRTDECL _tclen(__in const wchar_t *_Cpc)
{ 
    /* avoid compiler warning */
    (void *)_Cpc;
    return 1;
}
__inline void __CRTDECL _tccpy(__out wchar_t *_Pc1, __in const wchar_t *_Cpc2) { *_Pc1 = (wchar_t)*_Cpc2; }
__inline __checkReturn int __CRTDECL _tccmp(__in const wchar_t *_Cpc1, __in const wchar_t *_Cpc2) { return (int) ((*_Cpc1)-(*_Cpc2)); }
#endif  /* __STDC__ */
...
_CRTIMP __checkReturn size_t __cdecl __wcsncnt(__in_ecount(_MaxCount) const wchar_t * _P(_Str), __in size_t _P(_MaxCount));
...
#else   /* __STDC__ */
__inline __checkReturn wchar_t * __CRTDECL _wcsdec(__in const wchar_t * _Cpc1, __in const wchar_t * _Cpc2) { return (wchar_t *)((_Cpc1)>=(_Cpc2) ? NULL : ((_Cpc2)-1)); }
__inline __checkReturn wchar_t * __CRTDECL _wcsinc(__in const wchar_t * _Pc) { return (wchar_t *)(_Pc+1); }
__inline __checkReturn unsigned int __CRTDECL _wcsnextc(__in const wchar_t * _Cpc) { return (unsigned int)*_Cpc; }
__inline __checkReturn wchar_t * __CRTDECL _wcsninc(__in const wchar_t * _Pc, __in size_t _Sz) { return (wchar_t *)(_Pc+_Sz); }
__inline __checkReturn size_t __CRTDECL _wcsncnt( __in_ecount(_Cnt) const wchar_t * _String, __in size_t _Cnt) 
{ 
	size_t n = _Cnt; 
...
( 
    __in const wchar_t * _Cpc1, 
    __in const wchar_t * _Cpc2
)
{
    return _Cpc1==NULL ? NULL : ((*(_Cpc1 += wcsspn(_Cpc1,_Cpc2))!='\0') ? (wchar_t*)_Cpc1 : NULL); 
}

__inline wchar_t * __CRTDECL _wcsncpy_l(__out_ecount(_Count) wchar_t *_Destination, __in const wchar_t *_Source, __in size_t _Count, __in_opt _locale_t _Locale)
{
    _Locale; /* unused - suppresses warning */
#pragma warning( push )
...
__inline __checkReturn_wat errno_t __CRTDECL _wcsncpy_s_l(__out_ecount(_Destination_size_chars) wchar_t *_Destination, __in size_t _Destination_size_chars, __in const wchar_t *_Source, __in size_t _Count, __in_opt _locale_t _Locale)
{
    _Locale; /* unused - suppresses warning */
#pragma warning( push )
#pragma warning( disable : 4996 )
...
__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3(errno_t, _wcsncpy_s_l, __out_ecount(_Size) wchar_t, __in const wchar_t *, __in size_t, __in_opt _locale_t)

__inline wchar_t * __CRTDECL _wcsncat_l(__inout wchar_t *_Destination, __in const wchar_t *_Source, __in size_t _Count, __in_opt _locale_t _Locale)
{
    _Locale; /* unused - suppresses warning */
#pragma warning( push )
#pragma warning( disable : 4996 )
...
__inline __checkReturn_wat errno_t __CRTDECL _wcsncat_s_l(__inout_ecount(_Destination_size_chars) wchar_t *_Destination, __in size_t _Destination_size_chars, __in const wchar_t *_Source, __in size_t _Count, __in_opt _locale_t _Locale)
{
    _Locale; /* unused - suppresses warning */
#pragma warning( push )
#pragma warning( disable : 4996 )
...
__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3(errno_t, _wcsncat_s_l, __inout_ecount(_Size) wchar_t, __in const wchar_t *, __in size_t, __in_opt _locale_t)

__inline wchar_t * _wcstok_l(__inout_opt wchar_t * _String, __in const wchar_t * _Delimiters, __in_opt _locale_t _Locale) 
{
    _Locale; /* unused - suppresses warning */
#pragma warning(push)
#pragma warning(disable:4996)
...
__inline wchar_t * _wcstok_s_l(__inout_opt wchar_t * _String, __in const wchar_t * _Delimiters, __deref_inout_opt wchar_t **_Current_position, __in_opt _locale_t _Locale) 
{
    _Locale; /* unused - suppresses warning */
#pragma warning( push )
#pragma warning( disable : 4996 )
...
__inline wchar_t * __CRTDECL _wcsnset_l(__inout wchar_t * _Destination, __in wchar_t _Value, __in size_t _Count, __in_opt _locale_t _Locale)
{
    _Locale; /* unused - suppresses warning */
#pragma warning( push )
#pragma warning( disable : 4996 )
...
__inline errno_t _wcsnset_s_l(__inout_ecount(_Destination_size_chars) wchar_t * _Destination, __in size_t _Destination_size_chars, __in wchar_t _Value, __in size_t _Count, __in_opt _locale_t _Locale) 
{
    _Locale; /* unused - suppresses warning */
#pragma warning( push )
#pragma warning( disable : 4996 )
...
__inline wchar_t * __CRTDECL _wcsset_l(__inout wchar_t * _Destination, __in wchar_t _Value, __in_opt _locale_t _Locale)
{
    _Locale; /* unused - suppresses warning */
#pragma warning( push )
#pragma warning( disable : 4996 )
...
__inline errno_t _wcsset_s_l(__inout_ecount(_Destination_size_chars) wchar_t * _Destination, __in size_t _Destination_size_chars, __in wchar_t _Value, __in_opt _locale_t _Locale) 
{
    _Locale; /* unused - suppresses warning */
#pragma warning( push )
#pragma warning( disable : 4996 )
...
#define _vsntprintf_p   _vsnprintf_p
#define _vsntprintf_p_l _vsnprintf_p_l
...
_CRTIMP __checkReturn _CONST_RETURN char * __cdecl _tcschr(__in const char * _P(_Str), __in unsigned int _P(_Val));
_CRTIMP __checkReturn size_t __cdecl _tcscspn(__in const char * _P(_Str), __in const char * _P(_Control));
_CRTIMP char * __cdecl _tcsncat(__inout char *_P(_Dst), __in const char *_P(_Src), __in size_t _P(_MaxCount));
_CRTIMP char * __cdecl _tcsncat_s(__inout_ecount(_DstSizeInChars) char *_P(_Dst), __in size_t _P(_DstSizeInChars), __in const char *_P(_Src), size_t _P(_MaxCount));
_CRTIMP char * __cdecl _tcsncat_l(__inout char *_P(_Dst), __in const char *_P(_Src), __in size_t _P(_MaxCount), __in_opt _locale_t _P(_PtLoci));
_CRTIMP char * __cdecl _tcsncat_s_l(__inout_ecount(_DstSizeInChars) char *_P(_Dst), __in size_t _P(_DstSizeInChars), __in const char *_P(_Src), __in size_t _P(_MaxCount), __in_opt _locale_t _P(_PtLoci));
_CRTIMP char * __cdecl _tcsncpy(__out_ecount(_MaxCount) char *_P(_Dst), __in const char *_P(_Src), size_t _P(_MaxCount));
_CRTIMP char * __cdecl _tcsncpy_s(__out_ecount(_DstSizeInChars) char *_P(_Dst), __in size_t _P(_DstSizeInChars), __in const char *_P(_Src), size_t _P(_MaxCount));
_CRTIMP char * __cdecl _tcsncpy_l(__out_ecount(_MaxCount) char *_P(_Dst), __in const char *_P(_Src), __in size_t _P(_MaxCount), __in_opt _locale_t _P(_PtLoci));
_CRTIMP char * __cdecl _tcsncpy_s_l(__out_ecount(_DstSizeInChars) char *_P(_Dst), __in size_t _P(_DstSizeInChars), __in const char *_P(_Src), __in size_t _P(_MaxCount), __in_opt _locale_t _P(_PtLoci));
_CRTIMP __checkReturn _CONST_RETURN char * __cdecl _tcspbrk(__in const char * _P(_Str), __in const char * _P(_Control));
_CRTIMP __checkReturn _CONST_RETURN char * __cdecl _tcsrchr(__in const char * _P(_Str), __in unsigned int _P(_Ch));
_CRTIMP __checkReturn size_t __cdecl _tcsspn(__in const char * _P(_Str), __in const char * _P(_Control));
_CRTIMP __checkReturn _CONST_RETURN char * __cdecl _tcsstr(__in const char * _P(_Str), __in const char * _P(_Substr));
_CRTIMP __checkReturn char * __cdecl _tcstok(__inout_opt char *_P(_Str), __in const char *_P(_Delim));
_CRTIMP __checkReturn char * __cdecl _tcstok_s(__inout_opt char *_P(_Str), __in const char *_P(_Delim), __deref_inout_opt char **_P(_Context));
_CRTIMP __checkReturn char * __cdecl _tcstok_l(__inout_opt char *_P(_Str), __in const char *_P(_Delim), __in_opt _locale_t _P(_PtLoci));
_CRTIMP __checkReturn char * __cdecl _tcstok_s_l(__inout_opt char *_P(_Str), __in const char *_P(_Delim), __deref_inout_opt char **_P(_Context), __in_opt _locale_t _P(_PtLoci));

_CRTIMP char * __cdecl _tcsnset(__inout char * _P(_Str), __in unsigned int _P(_Val), __in size_t _P(_MaxCount));
_CRTIMP char * __cdecl _tcsrev(__inout char * _P(_Str));
_CRTIMP char * __cdecl _tcsset(__inout char * _P(_Str), __in unsigned int _P(_Val));
_CRTIMP char * __cdecl _tcsset_l(__inout char * _P(_Str), __in unsigned int _P(_Val), __in_opt _locale_t _P(_PtLoci));
_CRTIMP __checkReturn_wat errno_t __cdecl _tcsset_s(__inout_ecount(_SizeInChars) char * _P(_Str), __in size_t _P(_SizeInChars), __in unsigned int _P(_Val));
_CRTIMP __checkReturn_wat errno_t __cdecl _tcsset_s_l(__inout_ecount(_SizeInChars) char * _P(_Str), __in size_t _P(_SizeInChars), __in unsigned int, __in_opt _locale_t _P(_PtLoci));

_CRTIMP __checkReturn int __cdecl _tcscmp(__in const char *_P(_Str1), __in const char * _P(_Str));
_CRTIMP __checkReturn int __cdecl _tcsicmp(__in const char *_P(_Str1), __in const char *_P(_Str2));
_CRTIMP __checkReturn int __cdecl _tcsicmp_l(__in const char *_Str1, __in const char *_Str2, __in_opt _locale_t _P(_PtLoci));
_CRTIMP __checkReturn int __cdecl _tcsnccmp(__in const char * _P(_Str1), __in const char * _P(_Str2), __in size_t _P(_MaxCount));
_CRTIMP __checkReturn int __cdecl _tcsncmp(__in const char * _P(_Str1), __in const char * _P(_Str2), __in size_t _P(_MaxCount));
_CRTIMP __checkReturn int __cdecl _tcsncicmp(__in const char * _P(_Str1), __in const char * _P(_Str2), __in size_t _P(_MaxCount));
_CRTIMP __checkReturn int __cdecl _tcsncicmp_l(__in const char *_P(_Str1), __in const char *_P(_Str2), __in size_t _P(_MaxCount), __in_opt _locale_t _P(_PtLoci));
_CRTIMP __checkReturn int __cdecl _tcsnicmp(__in const char * _P(_Str1), __in const char * _P(_Str2), __in size_t _P(_MaxCount));
_CRTIMP __checkReturn int __cdecl _tcsnicmp_l(__in const char *_P(_Str1), __in const char *_P(_Str2), size_t _P(_MaxCount), __in_opt _locale_t _P(_PtLoci));

_CRTIMP __checkReturn int __cdecl _tcscoll(__in const char * _P(_Str1), __in const char * _P(_Str2));
_CRTIMP __checkReturn int __cdecl _tcscoll_l(__in const char *_P(_Str1), __in const char *_P(_Str2), __in_opt _locale_t _P(_PtLoci));
_CRTIMP __checkReturn int __cdecl _tcsicoll(__in const char * _P(_Str1), __in const char * _P(_Str2));
_CRTIMP __checkReturn int __cdecl _tcsicoll_l(__in const char *_P(_Str1), __in const char *_P(_Str2), __in_opt _locale_t _P(_PtLoci));
_CRTIMP __checkReturn int __cdecl _tcsnccoll(__in const char * _P(_Str1), __in const char * _P(_Str2), __in size_t _P(_MaxCount));
_CRTIMP __checkReturn int __cdecl _tcsnccoll_l(__in const char *_P(_Str1), __in const char *_P(_Str2), __in size_t _P(_MaxCount), __in_opt _locale_t _P(_PtLoci));
_CRTIMP __checkReturn int __cdecl _tcsncoll(__in const char *_P(_Str1), __in const char * _P(_Str2), __in size_t _P(_MaxCount));
_CRTIMP __checkReturn int __cdecl _tcsncoll_l(__in const char *_P(_Str1), __in const char *_P(_Str2), size_t _P(_MaxCount), __in_opt _locale_t _P(_PtLoci));
_CRTIMP __checkReturn int __cdecl _tcsncicoll(__in const char * _P(_Str1), __in const char * _P(_Str2), __in size_t _P(_MaxCount));
_CRTIMP __checkReturn int __cdecl _tcsncicoll_l(__in const char *_P(_Str1), __in const char *_P(_Str2), __in size_t _P(_MaxCount), __in_opt _locale_t _P(_PtLoci));
_CRTIMP __checkReturn int __cdecl _tcsnicoll(__in const char * _P(_Str1), __in const char * _P(_Str2), __in size_t _P(_MaxCount));
_CRTIMP __checkReturn int __cdecl _tcsnicoll_l(__in const char *_P(_Str1), __in const char *_P(_Str2), __in size_t _P(_MaxCount), __in_opt _locale_t _P(_PtLoci));

/* "logical-character" mappings */

_CRTIMP __checkReturn size_t __cdecl _tcsclen(__in const char *_P(_Str));
_CRTIMP __checkReturn size_t __cdecl _tcscnlen(__in_ecount(_MaxCount) const char *_P(_Str), __in size_t _P(_MaxCount));
_CRTIMP __checkReturn size_t __cdecl _tcsclen_l(__in const char *_P(_Str), __in_opt _locale_t _P(_PtLoci));
_CRTIMP __checkReturn size_t __cdecl _tcscnlen_l(__in const char *_P(_Str), __in size_t _P(_MaxCount), __in_opt _locale_t _P(_PtLoci));
_CRTIMP char * __cdecl _tcsnccat(__inout char *_P(_Dst), __in const char *_P(_Src), __in size_t _P(_MaxCount));
_CRTIMP char * __cdecl _tcsnccat_s(__inout_ecount(_DstSizeInChars) char *_P(_Dst), __in size_t _P(_DstSizeInChars), __in const char *_P(_Src), __in size_t _P(_MaxCount));
_CRTIMP char * __cdecl _tcsnccat_l(__inout char *_P(_Dst), __in const char *_P(_Src), __in size_t _P(_MaxCount), __in_opt _locale_t _P(_PtLoci));
_CRTIMP char * __cdecl _tcsnccat_s_l(__inout_ecount(_DstSizeInChars) char *_P(_Dst), __in size_t _P(_DstSizeInChars), __in const char *_P(_Src), __in size_t _P(_MaxCount), __in_opt _locale_t _P(_PtLoci));
_CRTIMP char * __cdecl _tcsnccpy(__out_ecount(_MaxCount) char *_P(_Dst), __in const char *_P(_Src), __in size_t _P(_MaxCount));
_CRTIMP char * __cdecl _tcsnccpy_s(__out_ecount(_DstSizeInChars) char *_P(_Dst), __in size_t _P(_DstSizeInChars), __in const char *_P(_Src), __in size_t _P(_MaxCount));
_CRTIMP char * __cdecl _tcsnccpy_l(__out_ecount(_DstSizeInChars) char *_P(_Dst), __in const char *_P(_Src), __in size_t _P(_MaxCount), __in_opt _locale_t _P(_PtLoci));
_CRTIMP char * __cdecl _tcsnccpy_s_l(__out_ecount(_DstSizeInChars) char *_P(_Dst), __in size_t _P(_DstSizeInChars), __in const char *_P(_Src), __in size_t _P(_MaxCount), __in_opt _locale_t _P(_PtLoci));
_CRTIMP char * __cdecl _tcsncset(__inout_ecount(_MaxCount) char * _P(_Str), __in unsigned int _P(_Val), __in size_t _P(_MaxCount));

/* MBCS-specific mappings */

_CRTIMP char * __cdecl _tcsdec(__in_ecount(_Pos-_Start+1) const char * _P(_Start), __in const char * _P(_Pos));
_CRTIMP char * __cdecl _tcsinc(__in const char * _P(_Ptr));
_CRTIMP size_t __cdecl _tcsnbcnt(__in_ecount(_MaxCount) const char * _P(_Str), __in size_t _P(_MaxCount));
_CRTIMP size_t __cdecl _tcsnccnt(__in_ecount(_MaxCount) const char * _P(_Str), __in size_t _P(_MaxCount));
_CRTIMP unsigned int __cdecl _tcsnextc (__in const char * _P(_Str));
_CRTIMP char * __cdecl _tcsninc(__in_ecount(_Count) const char * _P(_Ptr), __in size_t _P(_Count));
_CRTIMP char * __cdecl _tcsspnp(__in const char * _P(_Str1), __in const char * _P(_Str2));

_CRTIMP char * __cdecl _tcslwr(__inout char *_P(_Str));
_CRTIMP char * __cdecl _tcslwr_l(__inout char *_P(_Str), __in_opt _locale_t _P(_PtLoci));
_CRTIMP char * __cdecl _tcslwr_s(__inout_ecount(_SizeInChars) char *_P(_Str), __in size_t _P(_SizeInChars));
_CRTIMP char * __cdecl _tcslwr_s_l(__inout_ecount(_SizeInChars) char *_P(_Str), __in size_t _P(_SizeInChars), __in_opt _locale_t _P(_PtLoci));
_CRTIMP char * __cdecl _tcsupr(__inout char *_P(_Str));
_CRTIMP char * __cdecl _tcsupr_l(__inout char *_P(_Str), __in_opt _locale_t _P(_PtLoci));
_CRTIMP char * __cdecl _tcsupr_s(__inout_ecount(_SizeInChars) char *_P(_Str), __in size_t _P(_SizeInChars));
_CRTIMP char * __cdecl _tcsupr_s_l(__inout_ecount(_SizeInChars) char *_P(_Str), __in size_t _P(_SizeInChars), __in_opt _locale_t _P(_PtLoci));

_CRTIMP __checkReturn size_t __cdecl _tclen(__in const char * _P(_Str));
_CRTIMP void __cdecl _tccpy(__out char * _P(_DstCh), __in const char * _P(_SrcCh));
...
_CRT_INSECURE_DEPRECATE __inline char * _tcsncat(__inout char *_Destination, __in const char *_Source, __in size_t _Count) 
{
#pragma warning(push)
#pragma warning(disable:4996)
...
__inline __checkReturn_wat errno_t _tcsncat_s(__inout_bcount(_Destination_size_chars) char *_Destination, __in size_t _Destination_size_chars, __in const char *_Source, __in size_t _Count) 
{
    return _mbsnbcat_s((unsigned char *)_Destination, _Destination_size_chars, (const unsigned char *)_Source,_Count);
}

__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_2(errno_t, _tcsncat_s, __inout_ecount(_Size) char, __in const char *, __in size_t)

_CRT_INSECURE_DEPRECATE __inline char * _tcsncat_l(__inout char *_Destination, __in const char *_Source, __in size_t _Count, __in_opt _locale_t _Locale) 
{
#pragma warning(push)
#pragma warning(disable:4996)
...
__inline __checkReturn_wat errno_t _tcsncat_s_l(__inout_bcount(_Destination_size_chars) char *_Destination, __in size_t _Destination_size_chars, __in const char *_Source, __in size_t _Count, __in_opt _locale_t _Locale) 
{
    return _mbsnbcat_s_l((unsigned char *)_Destination, _Destination_size_chars, (const unsigned char *)_Source,_Count, _Locale);
}

__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3(errno_t, _tcsncat_s_l, __inout_ecount(_Size) char, const char *, size_t, _locale_t)

_CRT_INSECURE_DEPRECATE __inline char * _tcsncpy(__inout char * _Destination,__in const char * _Source,__in size_t _Count) 
{
#pragma warning(push)
#pragma warning(disable:4996)
...
__inline __checkReturn_wat errno_t _tcsncpy_s(__out_bcount(_Destination_size_chars) char * _Destination, __in size_t _Destination_size_chars, __in const char * _Source,__in size_t _Count) 
{
    return _mbsnbcpy_s((unsigned char *)_Destination, _Destination_size_chars, (const unsigned char *)_Source,_Count);
}

__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_2(errno_t, _tcsncpy_s, __out_bcount(_Size) char, __in const char *, __in size_t)

_CRT_INSECURE_DEPRECATE __inline char * _tcsncpy_l(__out_bcount(_Count) char * _Destination,__in const char * _Source,__in size_t _Count, __in_opt _locale_t _Locale) 
{
#pragma warning(push)
#pragma warning(disable:4996)
...
__inline __checkReturn_wat errno_t _tcsncpy_s_l(__out_bcount(_Destination_size_chars) char * _Destination, __in size_t _Destination_size_chars, __in const char * _Source,__in size_t _Count, __in_opt _locale_t _Locale) 
{
    return _mbsnbcpy_s_l((unsigned char *)_Destination, _Destination_size_chars, (const unsigned char *)_Source,_Count, _Locale);
}

__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3(errno_t, _tcsncpy_s, __out_bcount(_Size) char, __in const char *, __in size_t, __in_opt _locale_t)
...
_CRT_INSECURE_DEPRECATE __inline __checkReturn char *  _tcstok(__inout_opt char * _String,__in const char * _Delimiters) 
{
#pragma warning(push)
#pragma warning(disable:4996)
...
__inline __checkReturn char *  _tcstok_s(__inout_opt char * _String,__in const char * _Delimiters, __deref_inout_opt char **_Current_position) 
{
	return (char * )_mbstok_s((unsigned char *)_String,(const unsigned char *)_Delimiters, (unsigned char **)_Current_position);
}

_CRT_INSECURE_DEPRECATE __inline __checkReturn char *  _tcstok_l(__inout_opt char * _String,__in const char * _Delimiters, __in_opt _locale_t _Locale) 
{
#pragma warning(push)
#pragma warning(disable:4996)
...
__inline __checkReturn char *  _tcstok_s_l(__inout_opt char * _String,__in const char * _Delimiters, __deref_inout_opt char **_Current_position, __in_opt _locale_t _Locale) 
{
	return (char * )_mbstok_s_l((unsigned char *)_String,(const unsigned char *)_Delimiters, (unsigned char **)_Current_position, _Locale);
}

_CRT_INSECURE_DEPRECATE __inline char * _tcsnset(__inout_bcount(_Count) char * _Dst, __in unsigned int _Value , __in size_t _Count)
{
#pragma warning(push)
#pragma warning(disable:4996)
...
_CRT_INSECURE_DEPRECATE __inline char * _tcsnset_l(__inout_bcount(_Count) char * _Dst, __in unsigned int _Value , __in size_t _Count, __in_opt _locale_t _Locale)
{
#pragma warning(push)
#pragma warning(disable:4996)
...
__inline __checkReturn_wat errno_t _tcsnset_s(__inout_bcount(_SizeInBytes) char * _Dst, __in size_t _SizeInBytes, __in unsigned int _Value , __in size_t _Count)
{
    return _mbsnbset_s((unsigned char *)_Dst, _SizeInBytes, _Value, _Count);
}

__inline __checkReturn_wat errno_t _tcsnset_s_l(__inout_bcount(_SizeInBytes) char * _Dst, __in size_t _SizeInBytes, __in unsigned int _Value , __in size_t _Count, __in_opt _locale_t _Locale)
{
...
_CRT_INSECURE_DEPRECATE __inline char * _tcsset(__inout char * _Dst, __in unsigned int _Value)
{
#pragma warning(push)
#pragma warning(disable:4996)
...
_CRT_INSECURE_DEPRECATE __inline char * _tcsset_l(__inout char * _Dst, __in unsigned int _Value, __in_opt _locale_t _Locale)
{
#pragma warning(push)
#pragma warning(disable:4996)
...
__inline __checkReturn_wat errno_t _tcsset_s(__inout_bcount(_SizeInBytes) char * _Dst, __in size_t _SizeInBytes, __in unsigned int _Value)
{
    return _mbsset_s((unsigned char *)_Dst, _SizeInBytes, _Value);
}

__inline __checkReturn_wat errno_t _tcsset_s_l(__inout_bcount(_SizeInBytes) char * _Dst, __in size_t _SizeInBytes, __in unsigned int _Value, __in_opt _locale_t _Locale)
{
...
__inline __checkReturn int _tcsicmp(__in const char * _String1, __in const char * _String2) 
{
    return _mbsicmp((const unsigned char *)_String1,(const unsigned char *)_String2);
}

__inline __checkReturn int _tcsicmp_l(__in const char * _String1, __in const char * _String2, __in_opt _locale_t _Locale) 
{
...
__inline __checkReturn int _tcsncicmp(__in const char * _String1, __in const char * _String2, __in size_t _Char_count)
{
    return _mbsnicmp((const unsigned char *)_String1,(const unsigned char *)_String2,_Char_count);
}

__inline __checkReturn int _tcsncicmp_l(__in const char * _String1, __in const char * _String2, __in size_t _Char_count, __in_opt _locale_t _Locale)
{
    return _mbsnicmp_l((const unsigned char *)_String1,(const unsigned char *)_String2,_Char_count, _Locale);
}

__inline __checkReturn int _tcsnicmp(__in const char * _String1, __in const char * _String2, __in size_t _Char_count) 
{
    return _mbsnbicmp((const unsigned char *)_String1,(const unsigned char *)_String2,_Char_count);
}

__inline __checkReturn int _tcsnicmp_l(__in const char * _String1, __in const char * _String2, __in size_t _Char_count, __in_opt _locale_t _Locale) 
{
    return _mbsnbicmp_l((const unsigned char *)_String1,(const unsigned char *)_String2,_Char_count, _Locale);
}

__inline __checkReturn int _tcscoll(__in const char * _String1, __in const char * _String2)
{
    return _mbscoll((const unsigned char *)_String1,(const unsigned char *)_String2);
}

__inline __checkReturn int _tcscoll_l(__in const char * _String1, __in const char * _String2, __in_opt _locale_t _Locale)
{
    return _mbscoll_l((const unsigned char *)_String1,(const unsigned char *)_String2, _Locale);
}

__inline __checkReturn int _tcsicoll(__in const char * _String1, __in const char * _String2)
{
    return _mbsicoll((const unsigned char *)_String1,(const unsigned char *)_String2);
}

__inline __checkReturn int _tcsicoll_l(__in const char * _String1, __in const char * _String2, __in_opt _locale_t _Locale)
{
    return _mbsicoll_l((const unsigned char *)_String1,(const unsigned char *)_String2, _Locale);
}

__inline __checkReturn int _tcsnccoll(__in const char * _String1, __in const char * _String2, __in size_t _Count)
{
    return _mbsncoll((const unsigned char *)_String1,(const unsigned char *)_String2, _Count);
}

__inline __checkReturn int _tcsnccoll_l(__in const char * _String1, __in const char * _String2, __in size_t _Count, __in_opt _locale_t _Locale)
{
    return _mbsncoll_l((const unsigned char *)_String1,(const unsigned char *)_String2, _Count, _Locale);
}

__inline __checkReturn int _tcsncoll(__in const char * _String1, __in const char * _String2, __in size_t _Count)
{
    return _mbsnbcoll((const unsigned char *)_String1,(const unsigned char *)_String2, _Count);
}

__inline __checkReturn int _tcsncoll_l(__in const char * _String1, __in const char * _String2, __in size_t _Count, __in_opt _locale_t _Locale)
{
    return _mbsnbcoll_l((const unsigned char *)_String1,(const unsigned char *)_String2, _Count, _Locale);
}

__inline __checkReturn int _tcsncicoll(__in const char * _String1, __in const char * _String2, __in size_t _Count)
{
    return _mbsnicoll((const unsigned char *)_String1,(const unsigned char *)_String2, _Count);
}

__inline __checkReturn int _tcsncicoll_l(__in const char * _String1, __in const char * _String2, __in size_t _Count, __in_opt _locale_t _Locale)
{
    return _mbsnicoll_l((const unsigned char *)_String1,(const unsigned char *)_String2, _Count, _Locale);
}

__inline __checkReturn int _tcsnicoll(__in const char * _String1, __in const char * _String2, __in size_t _Count)
{
    return _mbsnbicoll((const unsigned char *)_String1,(const unsigned char *)_String2, _Count);
}

__inline __checkReturn int _tcsnicoll_l(__in const char * _String1, __in const char * _String2, __in size_t _Count, __in_opt _locale_t _Locale)
{
    return _mbsnbicoll_l((const unsigned char *)_String1,(const unsigned char *)_String2, _Count, _Locale);
}

/* "logical-character" mappings */
__inline __checkReturn size_t _tcsclen(__in const char * _String) 
{
    return _mbslen((const unsigned char *)_String);
}

__inline __checkReturn size_t _tcscnlen(__in const char * _String, __in size_t _Maximum) 
{
    return _mbsnlen((const unsigned char *)_String, _Maximum);
}

__inline __checkReturn size_t _tcsclen_l(__in const char * _String, __in_opt _locale_t _Locale) 
{
    return _mbslen_l((const unsigned char *)_String, _Locale);
}

__inline __checkReturn size_t _tcscnlen_l(__in const char * _String, __in size_t _Maximum, __in_opt _locale_t _Locale) 
{
    return _mbsnlen_l((const unsigned char *)_String, _Maximum, _Locale);
}

_CRT_INSECURE_DEPRECATE __inline char * _tcsnccat(__inout char * _Destination, __in const char * _Source, __in size_t _Count) 
{
#pragma warning(push)
#pragma warning(disable:4996)
...
__inline __checkReturn_wat errno_t _tcsnccat_s(__inout_bcount(_Destination_size_chars) char * _Destination, __in size_t _Destination_size_chars, __in const char * _Source, __in size_t _Count) 
{
    return _mbsncat_s((unsigned char *)_Destination, _Destination_size_chars, (const unsigned char *)_Source, _Count);
}

_CRT_INSECURE_DEPRECATE __inline char * _tcsnccat_l(__inout char * _Destination, __in const char * _Source, __in size_t _Count, __in_opt _locale_t _Locale) 
{
#pragma warning(push)
#pragma warning(disable:4996)
...
__inline __checkReturn_wat errno_t _tcsnccat_s_l(__inout_bcount(_Destination_size_chars) char * _Destination, __in size_t _Destination_size_chars, __in const char * _Source, __in size_t _Count, __in_opt _locale_t _Locale) 
{
    return _mbsncat_s_l((unsigned char *)_Destination, _Destination_size_chars, (const unsigned char *)_Source, _Count, _Locale);
}

_CRT_INSECURE_DEPRECATE __inline char * _tcsnccpy(__in char * _Destination, __in const char * _Source, __in size_t _Count) 
{
#pragma warning(push)
#pragma warning(disable:4996)
...
__inline __checkReturn_wat errno_t _tcsnccpy_s(__out_bcount(_Destination_size_chars) char * _Destination, __in size_t _Destination_size_chars, __in const char * _Source, __in size_t _Count) 
{
    return _mbsncpy_s((unsigned char *)_Destination, _Destination_size_chars, (const unsigned char *)_Source, _Count);
}

_CRT_INSECURE_DEPRECATE __inline char * _tcsnccpy_l(__out_bcount(_Count) char * _Destination, __in const char * _Source, __in size_t _Count, __in_opt _locale_t _Locale) 
{
#pragma warning(push)
#pragma warning(disable:4996)
...
__inline __checkReturn_wat errno_t _tcsnccpy_s_l(__out_bcount(_Destination_size_chars) char * _Destination, __in size_t _Destination_size_chars, __in const char * _Source, __in size_t _Count, __in_opt _locale_t _Locale) 
{
    return _mbsncpy_s_l((unsigned char *)_Destination, _Destination_size_chars, (const unsigned char *)_Source, _Count, _Locale);
}

_CRT_INSECURE_DEPRECATE __inline char * _tcsncset(__inout_bcount(_Count) char *_Destination, __in unsigned int _Value, __in size_t _Count)
{
#pragma warning(push)
#pragma warning(disable:4996)
...
_CRT_INSECURE_DEPRECATE __inline char * _tcsncset_l(__inout char *_Destination, __in unsigned int _Value, __in size_t _Count, __in_opt _locale_t _Locale)
{
#pragma warning(push)
#pragma warning(disable:4996)
...
_CRT_INSECURE_DEPRECATE __inline char * _tcslwr(__inout char * _String) 
{
#pragma warning(push)
#pragma warning(disable:4996)
...
__inline __checkReturn_wat errno_t _tcslwr_s(__inout_bcount(_SizeInBytes) char * _String, size_t _SizeInBytes) 
{
    return _mbslwr_s((unsigned char *)_String, _SizeInBytes);
}

__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_0(errno_t, _tcslwr_s, __inout_bcount(_Size) char)

_CRT_INSECURE_DEPRECATE __inline char * _tcslwr_l(__inout char * _String, __in_opt _locale_t _Locale) 
{
#pragma warning(push)
#pragma warning(disable:4996)
...
__inline __checkReturn_wat errno_t _tcslwr_s_l(__inout_bcount(_SizeInBytes) char * _String, __in size_t _SizeInBytes, __in_opt _locale_t _Locale) 
{
    return _mbslwr_s_l((unsigned char *)_String, _SizeInBytes, _Locale);
}

__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_1(errno_t, _tcslwr_s_l, __inout_bcount(_Size) char, __in_opt _locale_t)

_CRT_INSECURE_DEPRECATE __inline char * _tcsupr(__inout char * _String) 
{
#pragma warning(push)
#pragma warning(disable:4996)
...
__inline __checkReturn_wat errno_t _tcsupr_s(__inout_bcount(_Count) char * _String, __in size_t _Count) 
{
    return _mbsupr_s((unsigned char *)_String, _Count);
}

__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_0(errno_t, _tcsupr_s, __inout_bcount(_Size) char)

_CRT_INSECURE_DEPRECATE __inline char * _tcsupr_l(__inout char * _String, __in_opt _locale_t _Locale) 
{
#pragma warning(push)
#pragma warning(disable:4996)
...
__inline __checkReturn_wat errno_t _tcsupr_s_l(__inout_bcount(_Count) char * _String, __in size_t _Count, __in_opt _locale_t _Locale) 
{
    return _mbsupr_s_l((unsigned char *)_String, _Count, _Locale);
}

__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_1(errno_t, _tcsupr_s_l, __inout_bcount(_Size) char, __in_opt _locale_t)

__inline __checkReturn size_t _tclen(__in _CPC _s1) {return _mbclen((_CPUC)_s1);}

_CRT_INSECURE_DEPRECATE __inline void _tccpy(__out_bcount(2) char * _Destination, __in const char * _Source) 
{
#pragma warning(push)
#pragma warning(disable:4996)
...
_CRT_INSECURE_DEPRECATE __inline void _tccpy_l(__out_bcount(2) char * _Destination, __in const char * _Source, __in_opt _locale_t _Locale) 
{
#pragma warning(push)
#pragma warning(disable:4996)
...
__inline __checkReturn_wat errno_t _tccpy_s(__out_bcount(_SizeInBytes) char * _Destination, size_t _SizeInBytes, __out_opt int *_PCopied, __in const char * _Source) 
{
    return _mbccpy_s((unsigned char *)_Destination, _SizeInBytes, _PCopied, (const unsigned char *)_Source);
}

__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_2(errno_t, _tccpy_s, __out_bcount(_SizeInBytes) char, __out_opt  int *, __in const char *)

__inline __checkReturn_wat errno_t _tccpy_s_l(__out_bcount(_SizeInBytes) char * _Destination, __in size_t _SizeInBytes, __out_opt int *_PCopied, __in const char * _Source, __in_opt _locale_t _Locale) 
{
    return _mbccpy_s_l((unsigned char *)_Destination, _SizeInBytes, _PCopied, (const unsigned char *)_Source, _Locale);
}

__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3(errno_t, _tccpy_s_l, __out_bcount(_Size) char, __out_opt int *, __in const char *, __in_opt _locale_t)

/* inline helper */
__inline __checkReturn _UI _tcsnextc(__in _CPC _s1)
{
    _UI _n=0; 
...
extern "C++" {
inline __checkReturn char * __CRTDECL _tcschr(__in char *_S, __in unsigned int _C)
        {return ((char *)_tcschr((const char *)_S, _C)); }
inline __checkReturn char * __CRTDECL _tcspbrk(__in char *_S, __in const char *_P)
        {return ((char *)_tcspbrk((const char *)_S, _P)); }
inline __checkReturn char * __CRTDECL _tcsrchr(__in char *_S, __in unsigned int _C)
        {return ((char *)_tcsrchr((const char *)_S, _C)); }
inline __checkReturn char * __CRTDECL _tcsstr(__in char *_S, __in const char *_P)
