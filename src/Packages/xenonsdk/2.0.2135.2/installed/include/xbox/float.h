...
_CRT_MANAGED_FP_DEPRECATE _CRT_INSECURE_DEPRECATE _CRTIMP unsigned int __cdecl _controlfp(__in unsigned int _P(_NewValue),__in unsigned int _P(_Mask));
_CRT_MANAGED_FP_DEPRECATE _CRTIMP void __cdecl _set_controlfp(__in unsigned int _P(_NewValue), __in unsigned int _P(_Mask));
_CRT_MANAGED_FP_DEPRECATE _CRTIMP errno_t __cdecl _controlfp_s(__out_opt unsigned int *_P(_CurrentState), __in unsigned int _P(_NewValue), __in unsigned int _P(_Mask));
...
_CRT_MANAGED_FP_DEPRECATE _CRTIMP unsigned int __cdecl _control87(__in unsigned int _P(_NewValue),__in unsigned int _P(_Mask));
...
_CRTIMP __checkReturn double __cdecl _copysign (__in double _P(_Number), __in double _P(_Sign));
_CRTIMP __checkReturn double __cdecl _chgsign (__in double _P(_X));
_CRTIMP __checkReturn double __cdecl _scalb(__in double _P(_X), __in long _P(_Y));
_CRTIMP __checkReturn double __cdecl _logb(__in double _P(_X));
_CRTIMP __checkReturn double __cdecl _nextafter(__in double _P(_X), __in double _P(_Y));
_CRTIMP __checkReturn int    __cdecl _finite(__in double _P(_X));
_CRTIMP __checkReturn int    __cdecl _isnan(__in double _P(_X));
_CRTIMP __checkReturn int    __cdecl _fpclass(__in double _P(_X));
