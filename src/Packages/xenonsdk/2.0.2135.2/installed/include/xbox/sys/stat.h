...
_CRTIMP int __cdecl _fstat32(__in int _P(_FileDes), __out struct _stat32 * _P(_Stat));
_CRTIMP int __cdecl _stat32(__in const char * _P(_Name), __out struct _stat32 * _P(_Stat));

#if     _INTEGRAL_MAX_BITS >= 64
_CRTIMP int __cdecl _fstat32i64(__in int _P(_FileDes), __out struct _stat32i64 * _P(_Stat));
_CRTIMP int __cdecl _fstat64i32(__in int _P(_FileDes), __out struct _stat64i32 * _P(_Stat));
_CRTIMP int __cdecl _fstat64(__in int _P(_FileDes), __out struct _stat64 * _P(_Stat));
_CRTIMP int __cdecl _stat32i64(__in const char * _P(_Name), __out struct _stat32i64 * _P(_Stat));
_CRTIMP int __cdecl _stat64i32(__in const char * _P(_Name), __out struct _stat64i32 * _P(_Stat));
_CRTIMP int __cdecl _stat64(__in const char * _P(_Name), __out struct _stat64 * _P(_Stat));
#endif
