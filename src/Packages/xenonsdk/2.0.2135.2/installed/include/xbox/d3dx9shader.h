...
#define D3DXSHADER_SKIPMICROCODE            (1 << 16)  // Xbox extension
#define D3DXSHADER_SKIPMICROCODEOPTIMIZATION (1 << 17) // Xbox extension
#define D3DXSHADER_ZERO_INIT_LOCAL_VARS     (1 << 18)  // Xbox extension
#define D3DXSHADER_ENABLEVERIFIER           (1 << 22)  // Xbox extension
#define D3DXSHADER_MICROCODE_BACKEND_OLD    (1 << 23)  // Xbox extension
...
#define D3DXSHADER_VALID_ASSEMBLER_FLAGS \
    ( D3DXSHADER_DEBUG                    | \
    D3DXSHADER_SKIPVALIDATION           | \
    D3DXSHADER_SKIPMICROCODE            | \
    D3DXSHADER_SKIPMICROCODEOPTIMIZATION )
...
#define D3DXSHADER_VALID_COMPILER_FLAGS \
    ...
    D3DXSHADER_MICROCODE_BACKEND_OLD    | \
...
//----------------------------------------------------------------------------
// D3DXSHADER_ASSEMBLE_PARAMETERS:
//----------------------------------------------------------------------------

typedef HRESULT (CALLBACK *D3DXSHADER_UPDB_OUTPUTCALLBACK)(LPVOID pContext, LPCVOID pData, DWORD length);

typedef struct _D3DXSHADER_ASSEMBLE_PARAMETERSA
{
    ...
    LPVOID  UPDBOutputContext;          // Context passed to PDBOutputCallback
    D3DXSHADER_UPDB_OUTPUTCALLBACK UPDBOutputCallback;    // Used to report UPDB information
} D3DXSHADER_ASSEMBLE_PARAMETERSA, *LPD3DXSHADER_ASSEMBLE_PARAMETERSA;

typedef struct _D3DXSHADER_ASSEMBLE_PARAMETERSW
{
    DWORD   Flags;                      // D3DXSHADEREX_* flags
    DWORD   UPDBTimestamp;              // UPDB Timestamp for this compile.
    ...
    LPVOID  UPDBOutputContext;          // Context passed to PDBOutputCallback
    D3DXSHADER_UPDB_OUTPUTCALLBACK UPDBOutputCallback;    // Used to report UPDB information
} D3DXSHADER_ASSEMBLE_PARAMETERSW, *LPD3DXSHADER_ASSEMBLE_PARAMETERSW;

#ifdef UNICODE
#define D3DXSHADER_ASSEMBLE_PARAMETERS D3DXSHADER_ASSEMBLE_PARAMETERSW
#else
#define D3DXSHADER_ASSEMBLE_PARAMETERS D3DXSHADER_ASSEMBLE_PARAMETERSA
#endif
...
typedef struct _D3DXSHADER_COMPILE_PARAMETERSA
{
    ...
    DWORD   TempRegisterLimit;          // Maximum number of registers available to the generated microcode.
...
#define D3DXAssembleShaderFromFile D3DXAssembleShaderFromFileA
    ...
    HRESULT WINAPI
        ...
        LPD3DXBUFFER*                   ppShader,
        LPD3DXBUFFER*                   ppErrorMsgs,
        LPD3DXSHADER_ASSEMBLE_PARAMETERSA pParameters);
    ...
    HRESULT WINAPI
        ...
        LPD3DXBUFFER*                   ppShader,
        LPD3DXBUFFER*                   ppErrorMsgs,
        LPD3DXSHADER_ASSEMBLE_PARAMETERSW pParameters);
