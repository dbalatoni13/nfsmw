...
_CRTIMP int __cdecl _fpieee_flt(
        __in unsigned long _P(_ExceptionCode),
        __in struct _EXCEPTION_POINTERS * _P(_PtExceptionPtr),
        __in int (__cdecl * _P(_Handler))(_FPIEEE_RECORD *)
        );
...
_MRTIMP int __cdecl _fpieee_flt(
        __in unsigned long _P(_ExcpetionCode),
        __in struct _EXCEPTION_POINTERS * _P(_PtExceptionPtr),
        __in int (__clrcall * _P(_Handler))(_FPIEEE_RECORD *)
        );
