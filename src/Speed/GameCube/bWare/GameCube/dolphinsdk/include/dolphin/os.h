...
#define DOLPHIN_WEAK
#else
#define DOLPHIN_WEAK __declspec(weak)
#endif
...
DOLPHIN_WEAK void OSReport(const char* msg, ...);
DOLPHIN_WEAK void OSVReport(const char* msg, va_list list);
DOLPHIN_WEAK void OSPanic(const char* file, int line, const char* msg, ...);
...
DOLPHIN_WEAK extern int __OSIsGcam;
