...
SndBase::TypeInfo SFXCTL_Pathfinder::s_TypeInfo = {(int)0x01010000, "SFXCTL_Pathfinder", &SFXCTL::s_TypeInfo, SFXCTL_Pathfinder::CreateObject};
...
void SFXCTL_Pathfinder::CreateTrack(int index) {
    ...
    {
        char musname[64];
        bStrCat(musname, g_DataPaths[SNDPATH_PATHFINDER], m_pPFParms[index]->musfile);
...
void SFXCTL_Pathfinder::DetachStreamInstance(stPFParms *pstPFParms) {
    ...
    int nresult;
    nresult = static_cast<Path::PathTrackSndStream *>(trackimp)->DetachStreamInstance(pbuff);
...
void SFXCTL_Pathfinder::AttachStreamInstance(stPFParms *pstPFParms) {
    ...
    if (trackimp) {
        int nresult;
        nresult = static_cast<Path::PathTrackSndStream *>(trackimp)->AttachStreamInstance(mystreamhandle, pbuff);
    }
