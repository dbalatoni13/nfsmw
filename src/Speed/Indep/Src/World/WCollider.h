...
class WCollider : public UTL::Collections::Listable<WCollider, 100> {
  public:
    ...
    UMath::Vector3 fLastRequestedPosition;          // offset 0x14, size 0xC
    float fLastRequestedRadius;                     // offset 0x20, size 0x4
    UMath::Vector3 fPosition;                       // offset 0x24, size 0xC
    float fRadius;                                  // offset 0x30, size 0x4
    UMath::Vector3 fLastRefreshedPosition;          // offset 0x34, size 0xC
