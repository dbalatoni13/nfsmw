...
#define CARSLOTID_TO_VINYL_COLOUR_INDEX(id) (id - CARSLOTID_VINYL_COLOUR_FIRST) // TODO doesn't exist
...
#define CARSLOTID_FROM_VINYL_COLOUR_INDEX(index) (index + CARSLOTID_VINYL_COLOUR_FIRST) // TODO doesn't exist
