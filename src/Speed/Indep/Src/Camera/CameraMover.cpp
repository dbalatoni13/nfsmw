...
static float TrackCarIsoZoomDistance[3] = {3.3f, 3.3f, 3.3f};
static float TrackCarLookOffsetX[3] = {1.2f, -4.0f, 1.2f};
static float TrackCarLookOffsetY[3] = {0.0f, 0.0f, 0.0f};
static float TrackCarLookOffsetZ[3] = {-0.2f, -0.2f, 1.0f};
