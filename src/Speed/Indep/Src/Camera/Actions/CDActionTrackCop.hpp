#ifndef CAMERA_ACTIONS_CDACTIONTRACKCOP_H
#define CAMERA_ACTIONS_CDACTIONTRACKCOP_H
...
// total size: 0x50
class CDActionTrackCop : public CameraAI::Action, public IAttachable, public ITrafficCenter {
  public:
    ...
    CDActionTrackCop(CameraAI::Director *director, IPlayer *player);
    ~CDActionTrackCop() override;
    void Reset() override {}
  ...
  private:
    CameraMover *mMover;            // offset 0x28, size 0x4
    CameraAnchor *mAnchor;          // offset 0x2C, size 0x4
    WorldConn::Reference mTarget;   // offset 0x30, size 0x10
    IPlayer *mPlayer;               // offset 0x40, size 0x4
    Sim::Attachments *mAttachments; // offset 0x44, size 0x4
    IVehicle *mVehicle;             // offset 0x48, size 0x4
    EVIEW_ID mViewID;               // offset 0x4C, size 0x4
};
