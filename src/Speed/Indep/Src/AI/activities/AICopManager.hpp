...
class AICopManager : public Sim::Activity, public AISpawnManager, public ICopMgr, public IVehicleCache, public Debugable {
  ...
  private:
    UTL::Std::list<AICopManager::SpawnCopRequest, _type_AICopManagerSpawnRequests> mSpawnRequests; // offset 0x74, size 0x8
    UTL::Std::list<AICopManager::BreakerZone, _type_list> mBreakerZones;                           // offset 0x7C, size 0x8
    ...
    UTL::Std::list<IPursuit *, _type_AICopManagerPursuits> mIPursuitList;                          // offset 0x100, size 0x8
    UTL::Std::list<IRoadBlock *, _type_AICopManagerRoadBlocks> mRoadBlockList;                     // offset 0x108, size 0x8
