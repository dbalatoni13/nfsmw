...
IMPLEMENT_SAP_GRID(AIAvoidable);
AvoidableList AIAvoidable::mAll = AvoidableList();
...
void AIAvoidable::UpdateAllAvoidables(float dT) {
    ...
    unsigned int numiters = SAP::Grid<AIAvoidable>::Sweep();
    SAP::Grid<AIAvoidable>::Prune(overlapx < overlapz, OnOverLap, dT);
}
