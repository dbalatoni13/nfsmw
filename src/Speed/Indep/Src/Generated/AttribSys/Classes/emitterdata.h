...
struct emitterdata : Instance {
    struct _LayoutStruct {
        ...
        EA::Reflection::Bool NoKillAtAlpha;                  // offset 0x114, size 0x1
        EA::Reflection::Bool IsOneShot;                      // offset 0x118, size 0x1
        EA::Reflection::Bool StartDelayRandomVariance;       // offset 0x11c, size 0x1
        EA::Reflection::Bool EliminateUnnecessaryRandomness; // offset 0x120, size 0x1
    };
    ...
    static Key ClassKey();
    USE_ATTRIB_ALLOC("Attrib::Gen::emitterdata");
