...
struct rigidbodyspecs : Instance {
    struct _LayoutStruct {
        ...
        EA::Reflection::Bool IMMOBILE_OBJECT_COLLISIONS; // offset 0x100, size 0x1
        EA::Reflection::Bool NO_WORLD_COLLISIONS;        // offset 0x104, size 0x1
        EA::Reflection::Bool INSTANCE_COLLISIONS_3D;     // offset 0x108, size 0x1
        EA::Reflection::Bool NO_OBJ_COLLISIONS;          // offset 0x10c, size 0x1
    };
    ...
    static Key ClassKey();
    USE_ATTRIB_ALLOC("Attrib::Gen::rigidbodyspecs");
