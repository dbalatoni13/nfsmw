...
class ESpawnExplosion : public Event {
  public:
    ...
    ESpawnExplosion(UCrc32 pPosition, float pSpeed, float pRadius, float pStartRadius, unsigned int pEffectThis, unsigned int pDoesDamage, unsigned int pIncludePlayers, unsigned int pExcludeVehicles, unsigned int pExcludeSmackables, unsigned int phModel);

    override virtual ~ESpawnExplosion();
