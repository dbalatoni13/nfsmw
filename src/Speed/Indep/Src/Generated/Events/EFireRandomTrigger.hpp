...
class EFireRandomTrigger : public Event {
  public:
    ...
    EFireRandomTrigger(Trigger * pTrigger1, float pChance1, Trigger * pTrigger2, float pChance2, Trigger * pTrigger3, float pChance3, Trigger * pTrigger4, float pChance4, unsigned int phSimable);

    override virtual ~EFireRandomTrigger();
