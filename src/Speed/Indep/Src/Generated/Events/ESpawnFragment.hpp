...
class ESpawnFragment : public Event {
  public:
    ...
    ESpawnFragment(UCrc32 pPartName, UCrc32 pCollisionName, UCrc32 pAttributeName, UCrc32 pJointName, unsigned int pAllowDupes, float pInheritVelocity, unsigned int pHideParent, unsigned int pHidePart, unsigned int pAllowHiddenSpawn, unsigned int pNoPhysics, unsigned int pSimplePhysics, unsigned int phModel, UMath::Vector4 pVelocity, UMath::Vector4 pAngularVelocity);

    override virtual ~ESpawnFragment();
