...
class EScheduleEventUpdate : public Event {
  public:
    ...
    EScheduleEventUpdate(void *pStaticData, CARP::EventList *pEventList, int pTaskHandle, float pExecuteOnSimTime, int pResetCount);
  ...
  private:
    ...
    CARP::EventList *fEventList; // offset: 0xc, size 0x4
