...
class EPlayRaceNIS : public Event {
  public:
    ...
    EPlayRaceNIS(GMarker * pStartMarker, const char * pSceneName, const char * pSceneType, int pPlayerIdx, int pCameraTrack, const char * pPreMovie, const char * pPostMovie);

    override virtual ~EPlayRaceNIS();
