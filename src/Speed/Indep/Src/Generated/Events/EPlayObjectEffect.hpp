...
class EPlayObjectEffect : public Event {
  public:
    ...
    EPlayObjectEffect(const char * pEffect, UCrc32 pPosition, float pIntensity, UCrc32 pID, unsigned int pTracking, unsigned int pAllowHiddenSpawn, unsigned int phModel, UMath::Vector4 pVelocity);

    override virtual ~EPlayObjectEffect();
