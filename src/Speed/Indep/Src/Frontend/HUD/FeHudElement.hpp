...
// MW-specific bits verified against the GC binary (SetHudFeatures/DetermineHudFeatures)
#define HUD_FEATURE_ENGINE_TEMP MAKE_HUD_FEATURE(6)
#define HUD_FEATURE_GETAWAY_METER MAKE_HUD_FEATURE(9)
#define HUD_FEATURE_COST_TO_STATE MAKE_HUD_FEATURE(12)
#define HUD_FEATURE_TURBO_METER MAKE_HUD_FEATURE(17)
#define HUD_FEATURE_BUSTED_METER MAKE_HUD_FEATURE(23)
#define HUD_FEATURE_SPEEDOMETER MAKE_HUD_FEATURE(27)
#define HUD_FEATURE_INFRACTIONS MAKE_HUD_FEATURE(33)
#define HUD_FEATURE_MILESTONE_BOARD MAKE_HUD_FEATURE(34)
