...
class Minimap : public HudElement {
  public:
    ...
    struct GameplayIconInfo {           // Decl: speed/indep/src/frontend/hud/FeMinimap.hpp:63
        ...
        unsigned int mWorldMapTitle;    // offset 0xC, size 0x4, Decl: speed/indep/src/frontend/hud/FeMinimap.hpp:63
        unsigned int mworldIconTexHash; // offset 0x10, size 0x4, Decl: speed/indep/src/frontend/hud/FeMinimap.hpp:63
  ...
  private:
    ...
    static struct GameplayIconInfo kGameplayIconInfo[]; // size: 0x0, address: 0x8041BCA0, Decl: speed/indep/src/frontend/hud/FeMinimap.cpp:69
};
