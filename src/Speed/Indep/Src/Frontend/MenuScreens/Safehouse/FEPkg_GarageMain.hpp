...
namespace Attrib { namespace Gen { struct frontend; } }
...
struct GarageMainScreen : public MenuScreen {
    ...
    void SetRideInfo(RideInfo *ride, enum eSetRideInfoReasons reason);
    void CancelCarLoad();
    ...
    struct GarageCarLoader *TheGarageCarLoader;  // offset 0x2C, size 0x4
    enum eSetRideInfoReasons LoadingReason;      // offset 0x30, size 0x4
