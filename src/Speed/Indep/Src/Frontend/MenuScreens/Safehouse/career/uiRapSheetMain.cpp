...
uiRapSheetMain::uiRapSheetMain(ScreenConstructorData *sd) : UIWidgetMenu(sd) {
    button_pressed = 0;
    RefreshHeader();
}
...
void uiRapSheetMain::NotificationMessage(u32 msg, FEObject *pobj, u32 param1, u32 param2) {
    ...
    case 0xE1FDE1D1: {
        ...
        case __BUTTON_1__:
            cFEng::Get()->QueuePackageSwitch("RapSheetRS.fng", 0, 0, 0);
            break;
        case __BUTTON_2__:
            cFEng::Get()->QueuePackageSwitch("RapSheetVD.fng", 0, 0, 0);
            button_num = 2;
            break;
        case 0xCDA0A66D:
            cFEng::Get()->QueuePackageSwitch("RapSheetUS.fng", 0, 0, 0);
            button_num = 3;
            break;
        case 0xCDA0A66E:
            cFEng::Get()->QueuePackageSwitch("RapSheetCTS.fng", 0, 0, 0);
            button_num = 4;
            break;
        case 0xCDA0A66F:
            cFEng::Get()->QueuePackageSwitch("RapSheetTEP.fng", 0, 0, 0);
            button_num = 5;
            break;
        case 0xCDA0A670:
            cFEng::Get()->QueuePackageSwitch("RapSheetRankings.fng", 0, 0, 0);
            button_num = 6;
            break;
        default:
...
void uiRapSheetMain::RefreshHeader() {
    ...
    FEPrintf(GetPackageName(), 0xE3DA78E9, GetLocalizedString(0xA355FEDD), scores->CareerPursuitDetails.GetValue(PD_COST_TO_STATE));
