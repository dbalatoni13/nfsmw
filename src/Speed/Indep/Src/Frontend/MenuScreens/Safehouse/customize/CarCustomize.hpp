...
// TODO: de FEShoppingCartItem para abajo este fichero NO COMPILA, y nunca lo
// habia hecho porque nadie lo incluia. Le falta la clase base FEStatWidget,
// que no existe en ninguna parte del arbol, y con ella UIWidgetMenu,
// IconOption e IconScrollerMenu. Se deja tapado en vez de borrarlo para no
// perder el volcado del DWARF: es la plantilla de las 260 funciones de
// customize/. CustomizeMeter, lo unico que se usa hoy desde
// uiQRCarSelect.hpp, queda arriba y fuera del guard.
...
extern bool g_bCustomizeManagerHasControl;
extern bool g_bTestCareerCustomization;
extern char *g_pCustomizeMainPkg;
extern char *g_pCustomizeSubPkg;
extern char *g_pCustomizeSubTopPkg;
extern char *g_pCustomizePartsPkg;
extern char *g_pCustomizePerfPkg;
extern char *g_pCustomizeDecalsPkg;
extern char *g_pCustomizePaintPkg;
extern char *g_pCustomizeRimsPkg;
extern char *g_pCustomizeHudPkg;
extern char *g_pCustomizeHudColorPkg;
extern char *g_pCustomizeSpoilerPkg;
extern char *g_pCustomizeShoppingCartPkg;
