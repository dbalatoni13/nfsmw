...
void CustomizeSub::NotificationMessage(unsigned long msg, FEObject *pobj, unsigned long param1, unsigned long param2) {
    ...
    switch (msg) {
                ...
                case 0x803:
                    if (to_cat == 0x303) {
                        ...
                        if (stock_rim == installed) {
                            DialogInterface::ShowOneButton(GetPackageName(), "", static_cast<eDialogTitle>(1), 0x417b2601u, 0xb4edeb6du, 0xbdb19a9fu);
                        } else {
        ...
        case 0xc519bfc3:
            ...
            if (Category != 0x802)
                return;
            DialogInterface::ShowTwoButtons(GetPackageName(), "", static_cast<eDialogTitle>(3), 0x70e01038u, 0x417b25e4u, 0x6820e23eu, 0xb4edeb6du,
