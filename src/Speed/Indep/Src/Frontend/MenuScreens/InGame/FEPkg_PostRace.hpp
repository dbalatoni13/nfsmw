...
struct FEString *FEngFindString(const char *pkg_name, int name_hash) {
    ...
    struct GenericStat : public RaceStat {
        GenericStat(FEString *title, FEString *data, float stat_data, unsigned int title_hash, unsigned int units_hash, const char *format)
            : RaceStat(title, data) //
              ,
              StatData(stat_data) //
              ,
    ...
    struct GenericResult : public ResultStat {
        GenericResult(FEString *name, FEString *data, FEString *pos, unsigned int units_hash, float fdata, const char *format, GRacerInfo *racer_info)
    ...
    struct PursuitResultsDatum : public ArrayDatum {
        ...
        PursuitResultsDatum(PursuitResultsDatumType type, unsigned int itemName, float itemNumber, float itemGoal,
