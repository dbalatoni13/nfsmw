...
struct UIMemcardBase : public UIMemcardKeyboard {
    ...
    void NotificationMessage(unsigned long msg, FEObject *obj, unsigned long param1, unsigned long param2) override;
    void HandleButtonPressed(unsigned long msg, FEObject *obj, unsigned long param1, unsigned long param2, bool bSound);
    void HideAllButtons();
    ...
    void InitComplete();
    void ExitComplete();
    void NotificationMessageGoThroughAll(unsigned long msg, FEObject *obj, unsigned long param1, unsigned long param2);
