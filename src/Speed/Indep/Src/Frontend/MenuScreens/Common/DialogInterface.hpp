...
struct DialogInterface {
    ...
    static int DismissDialog(int handle);
    ...
    static int ShowTwoButtons(const char* from_pkg, const char* dlg_pkg, eDialogTitle title,
                              unsigned int button1_text_hash, unsigned int button2_text_hash,
                              unsigned int button1_pressed_message,
                              unsigned int button2_pressed_message,
                              eDialogFirstButtons first_button, unsigned int cancel_message, ...);
    static int ShowTwoButtons(const char* from_pkg, const char* dlg_pkg, eDialogTitle title,
                              unsigned int button1_text_hash, unsigned int button2_text_hash,
                              unsigned int button1_pressed_message,
                              unsigned int button2_pressed_message, unsigned int cancel_message,
                              bool detect_controller, eDialogFirstButtons first_button,
                              const char* blurb, ...);
    ...
    static int ShowOneButton(const char* from_pkg, const char* dlg_pkg, eDialogTitle title,
                             unsigned int button_text_hash, unsigned int button_pressed_message,
                             unsigned int cancel_message, bool detect_controller,
                             const char* blurb, ...);
    ...
    static int ShowThreeButtons(const char* from_pkg, const char* dlg_pkg, eDialogTitle title,
                                ...
                                unsigned int button1_pressed_message,
                                unsigned int button2_pressed_message, unsigned int button3_pressed_message,
                                eDialogFirstButtons first_button, unsigned int blurb_hash, ...);
    static void ShowOk(const char* from_pkg, const char* dlg_pkg, eDialogTitle title,
                       unsigned int blurb_hash, ...);
    static void ShowOk(const char* from_pkg, const char* dlg_pkg, eDialogTitle title,
                       const char* blurb, __va_list_tag* args);
};
