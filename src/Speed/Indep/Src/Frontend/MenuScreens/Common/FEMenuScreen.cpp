...
MenuScreen::MenuScreen(ScreenConstructorData *sd) : mDirectionForNextSound(0), bEnableEAMessenger(false) {
    ConstructData = *sd;
    ...
    bool set_current = bStrCmp(PackageFilename, "InGameDialog.fng") != 0                  //
        ...
        && !cFEng::Get()->IsPackagePushed("OL_EAMessenger.fng");
    if (set_current) {
...
MenuScreen::~MenuScreen() {
    ...
    bool clear_current = bStrCmp(PackageFilename, "InGameDialog.fng") != 0 && bStrCmp(PackageFilename, "OL_Dialog.fng") != 0 &&
...
void MenuScreen::FEngBeginTextInput(uint32 /* object_hash */, uint32 edit_mode, const char *initial_string, const char *title_string,
    ...
    bStrNCpy(FEDatabase->mFEKeyboardSettings.Buffer, initial_string, sizeof(settings.Buffer));
    ...
    FEDatabase->mFEKeyboardSettings.DefaultTextHash = is_plat_pc;
    bMemSet(FEDatabase->mFEKeyboardSettings.Title, 0, sizeof(settings.Title));
    bStrNCpy(FEDatabase->mFEKeyboardSettings.Title, title_string, sizeof(settings.Title) - 1);
    ...
    switch (edit_mode) {
        ...
        case 4:
            kbd_mode = 4;
            break;
        case 5: kbd_mode = 2; break;
        case 6: kbd_mode = 3; break;
        case 1:
        case 3:
            break;
    }
...
void MenuScreen::BaseNotifySound(u32 msg, FEObject * /* obj */, u32 /* controller_mask */, u32 /* pkg_ptr */) {
    ...
    switch (msg) {
        ...
        case 0xAC57BDB2:
            ...
            break;
        case __UISND_MAP_LOCK_TARGER__:
        ...
        case 0x2AC2CD24:
            ...
            break;
        case 0x802009F9:
            soundToPlay = static_cast<eMenuSoundTriggers>(0x30);
            break;
        case 0xDDD9C41E:
        ...
        case 0xB86367CB:
            ...
            break;
        case __UISND_OPTION_MENU_EXIT__:
        ...
        case 0x6E437A7B:
            ...
            break;
        case 0x4A7C2341:
            soundToPlay = static_cast<eMenuSoundTriggers>(0x0);
            break;
        case 0x480DF13F:
        ...
        case 0x4A805994:
            ...
            break;
        case 0x48122792:
            soundToPlay = static_cast<eMenuSoundTriggers>(0x2);
            break;
        case 0x4AC5E165:
            soundToPlay = static_cast<eMenuSoundTriggers>(0x2);
            break;
        ...
        case 0x610FB237:
        case 0x610FB238:
            soundToPlay = static_cast<eMenuSoundTriggers>(0x7);
            break;
        case 0x9B59E056:
