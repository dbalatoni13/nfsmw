...
// La definicion vive en World/RaceParameters.cpp; aqui era un duplicado
// que metia su constructor en el static-init de zAnim (stw r0,0x98).
// El objetivo solo la REFERENCIA en esta unidad (lwz, nunca construye).
