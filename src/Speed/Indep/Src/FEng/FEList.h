...
class FEList : public FEMinList {
  public:
    ...
    FENode *FindNode(u32 ordinalnumber) const {
        return static_cast<FENode *>(FEMinList::FindNode(ordinalnumber));
    }
...
class FEHashNode : public FEMinNode {
  ...
  public:
    ...
    FEHashNode *GetNext() const {
        return static_cast<FEHashNode *>(FEMinNode::GetNext());
    }

    FEHashNode *GetPrev() const {
        return static_cast<FEHashNode *>(FEMinNode::GetPrev());
    }
};
...
class FEHashList {
  ...
  public:
    ...
    FEHashNode *GetHead() const {
        return static_cast<FEHashNode *>(NodeList.GetHead());
    }

    FEHashNode *GetTail() const {
        return static_cast<FEHashNode *>(NodeList.GetTail());
    }
};
