...
struct FEObjectMouseState {
    ...
    inline bool GetBit(unsigned long bit) {
        return (Flags & bit) != 0;
    }
...
class FEPackage : public FENode {
  public:
    ...
    inline FEObject *GetCurrentButton() {
        return pCurrentButton;
    }
    inline FEButtonMap *GetButtonMap() {
        return &ButtonMap;
    }
    inline FEObject *GetFirstObject() {
        return static_cast<FEObject *>(Objects.GetHead());
    }
    inline FEMessageResponse *GetFirstResponse() {
        return reinterpret_cast<FEMessageResponse *>(Responses.GetHead());
    }
    inline FEPackage *GetNext() {
        return static_cast<FEPackage *>(FENode::GetNext());
    }
    inline FEPackage *GetPrev() {
        return static_cast<FEPackage *>(FENode::GetPrev());
    }
    inline unsigned long GetControlMask() const {
        return Controllers;
    }
    inline void SetControlMask(unsigned long ControlMask) {
        Controllers = ControlMask;
    }
    inline unsigned long GetOldControlMask() const {
        return OldControllers;
    }
    inline void SetOldControlMask(unsigned long ControlMask) {
        OldControllers = ControlMask;
    }
    inline void SetErrorScreen(bool b) {
        bErrorScreen = b;
    }
    inline bool IsInputEnabled() const {
        return bInputEnabled;
    }
    inline void SetInputEnabled(bool b) {
        bInputEnabled = b;
    }
    inline bool IsErrorScreen() const {
        return bErrorScreen;
    }
    inline int GetPriority() const {
        return Priority;
    }
    inline void SetPriority(int NewPri) {
        Priority = NewPri;
    }
    inline bool IsLibrary() const {
        return bIsLibrary;
    }
    inline void SetStartEqualsAccept(bool bVal) {
        bStartEqualsAccept = bVal;
    }
    inline bool StartEqualsAccept() const {
        return bStartEqualsAccept;
    }
    inline unsigned long GetUserParam() const {
        return UserParam;
    }
    inline void SetUserParam(unsigned long NewParam) {
        UserParam = NewParam;
    }
    inline void SetParentPackage(FEPackage *pPack) {
        pParentPackage = pPack;
    }
    inline FEPackage *GetParentPackage() {
    ...
    inline unsigned long GetNumParentObjects() {
        return Objects.GetNumElements();
    }
    inline void SetTickIncrement(int tDeltaTicks) {
        iTickIncrement = tDeltaTicks;
    }
    inline void SetExecute(bool bExec) {
        bExecuting = bExec;
    }
    inline void SetUseIdleList(bool bUseIdle) {
        bUseIdleList = bUseIdle;
    }
    inline bool UsesIdleList() {
        return bUseIdleList;
    }
    inline FEObject *GetLastObject() {
        return static_cast<FEObject *>(Objects.GetTail());
    }
    inline void AddObject(FEObject *pObject) {
        Objects.AddTail(static_cast<FEMinNode *>(pObject));
    }
    inline void AddObjectAfter(FEObject *pObject, FEObject *pAddAfter) {
        Objects.AddNode(static_cast<FEMinNode *>(pAddAfter), static_cast<FEMinNode *>(pObject));
    }
    inline void RemoveObject(FEObject *pObject) {
        Objects.RemNode(static_cast<FEMinNode *>(pObject));
    }
    inline unsigned long GetNumResponses() {
        return Responses.GetNumElements();
    }
    inline void AddResponse(FEMessageResponse *pResp) {
        Responses.AddTail(reinterpret_cast<FEMinNode *>(pResp));
    }
    inline void PurgeResponses() {
        Responses.Purge();
    }
    inline void RemoveResponse(FEMessageResponse *pResp) {
        Responses.RemNode(reinterpret_cast<FEMinNode *>(pResp));
    }
    inline FEMessageResponse *GetResponse(unsigned long Index) {
        return reinterpret_cast<FEMessageResponse *>(Responses.FindNode(Index));
    }
    inline const FEMsgTargetList *GetMessageTargetList(unsigned long Index) const {
