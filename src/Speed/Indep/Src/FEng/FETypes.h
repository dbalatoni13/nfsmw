...
struct FEVector2 {
    ...
    inline FEVector2(const FEVector2 &v) {
        *this = v;
    }

    inline FEVector2 operator+(const FEVector2 &v) const {
        return FEVector2(x + v.x, y + v.y);
    }
    inline FEVector2 operator-(const FEVector2 &v) const {
        return FEVector2(x - v.x, y - v.y);
    }
    inline FEVector2 operator*(float f) const {
        return FEVector2(x * f, y * f);
    }
    inline FEVector2 operator/(float f) const {
        return FEVector2(x / f, y / f);
    }
    inline FEVector2 &operator=(const FEVector2 &v) {
        x = v.x;
        y = v.y;
        return *this;
    }
    inline FEVector2 &operator+=(FEVector2 v) {
        x += v.x;
        y += v.y;
        return *this;
    }
    ...
    inline FEVector2 &operator*=(float f) {
        x *= f;
        y *= f;
        return *this;
    }

    inline float Dot(const FEVector2 &v) const {
        return x * v.x + y * v.y;
    }
...
struct FEVector3 {
    ...
    inline FEVector3(const FEVector3 &v) {
        *this = v;
    }

    inline FEVector3 &operator=(const FEVector3 &v) {
        x = v.x;
        y = v.y;
        z = v.z;
        return *this;
    }
    inline FEVector3 operator-(const FEVector3 &v) const {
        return FEVector3(x - v.x, y - v.y, z - v.z);
    }
    inline FEVector3 &operator*=(float f) {
        x *= f;
        y *= f;
        z *= f;
        return *this;
...
struct FEQuaternion {
    ...
    inline FEQuaternion &operator=(const FEQuaternion &q) {
        x = q.x;
        y = q.y;
        z = q.z;
        w = q.w;
...
struct FERect {
    ...
    inline FERect &operator=(const FERect &r) {
        left = r.left;
        top = r.top;
        right = r.right;
        bottom = r.bottom;
...
struct FEPoint {
    ...
    inline FEPoint &operator=(const FEPoint &p) {
        h = p.h;
        v = p.v;
        return *this;
    }
