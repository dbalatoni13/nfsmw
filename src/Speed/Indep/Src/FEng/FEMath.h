...
class FEQuaternion {
  public:
    ...
    FEQuaternion operator*(const FEQuaternion &q1) {
        FEQuaternion qRet;
        qRet.x = y * q1.z - z * q1.y;
        qRet.y = z * q1.x - x * q1.z;
        qRet.z = x * q1.y - y * q1.x;
        qRet.x += x * q1.w + q1.x * w;
        qRet.y += y * q1.w + q1.y * w;
        qRet.z += z * q1.w + q1.z * w;
        qRet.w = w * q1.w - (x * q1.x + y * q1.y + z * q1.z);
        return qRet;
    }
