...
struct NullAllocatorFlags : public EA::TagValuePair {
    NullAllocatorFlags() {
        mTag = 0;
        mNext = NULL;
        mValue.mInt = 0;
...
struct ICoreToIAllocatorAdaptor : public EA::Allocator::ICoreAllocator {
    ...
    static ICoreToIAllocatorAdaptor *CreateInstance(EA::Allocator::IAllocator *pAllocator) {
        ICoreToIAllocatorAdaptor *ptemp = new (pAllocator->Alloc(sizeof(ICoreToIAllocatorAdaptor), NullAllocatorFlags())) ICoreToIAllocatorAdaptor;
        return ptemp;
    }
